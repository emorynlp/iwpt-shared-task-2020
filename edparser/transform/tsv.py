...
from edparser.utils.io_util import generator_words_tags_from_tsv
from edparser.utils.tf_util import str_tensor_to_str
...
def dataset_from_tsv(tsv_file_path, word_vocab: VocabTF, char_vocab: VocabTF, tag_vocab: VocabTF, batch_size=32,
    ...
    generator = functools.partial(generator_words_tags_from_tsv, tsv_file_path, word_vocab, char_vocab, tag_vocab, lower)
...
class TsvTaggingFormat(Transform, ABC):
    def file_to_inputs(self, filepath: str, gold=True):
        ...
        yield from generator_words_tags_from_tsv(filepath, gold=gold, lower=self.config.get('lower', False),
