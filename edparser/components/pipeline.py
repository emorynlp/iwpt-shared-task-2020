...
from edparser.components.lambda_wrapper import LambdaComponent
from edparser.common.component import Component
from edparser.common.document import Document
from edparser.utils.component_util import load_from_meta
from edparser.utils.io_util import save_json, load_json
from edparser.utils.reflection import module_path_of, str_to_type, class_path_of
import edparser
...
class Pipeline(Component, list):
    ...
    def meta(self):
        return {
            ...
            'hanlp_version': edparser.version.__version__,
