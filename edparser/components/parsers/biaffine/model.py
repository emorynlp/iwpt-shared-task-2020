...
from edparser.layers.transformers.tf_imports import TFPreTrainedModel

from edparser.components.parsers.biaffine.layers import IndependentDropout, SharedDropout, Biaffine, \
...
class StructuralAttentionModel(tf.keras.Model):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        x = BiaffineModel.run_transformer(self, input_ids, input_mask, prefix_offset)
